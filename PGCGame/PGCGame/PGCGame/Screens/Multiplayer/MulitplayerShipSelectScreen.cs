...
namespace PGCGame.Screens.Multiplayer
{
    public class MulitplayerShipSelectScreen : BaseSelectScreen
    {
        ...
        public override void InitScreen(ScreenType screenType)
        {
            ...
            battleCruiser.Image = new Sprite(GameContent.GameAssets.Images.Ships[ShipType.BattleCruiser, ShipTier.Tier2], Vector2.Zero, Sprites.SpriteBatch);
            ...
            torpedoShip.Image = new Sprite(GameContent.GameAssets.Images.Ships[ShipType.TorpedoShip, ShipTier.Tier2], Vector2.Zero, Sprites.SpriteBatch);
        ...
        {
            StateManager.NetworkData.SelectedNetworkShip = MultiplayerShips[selected].Type;
