...
namespace PGCGame.Screens.Multiplayer
{
    public class MulitplayerShipSelectScreen : BaseSelectScreen
    {
        ...
        void MulitplayerShipSelectScreen_nextButtonClicked(object sender, EventArgs e)
        {
            ...
            StateManager.NetworkData.SendData("MPShip.SelectedType", StateManager.NetworkData.SelectedNetworkShip.Type.ToString());
            StateManager.NetworkData.WriteNetworkData(SendDataOptions.Reliable, null);
